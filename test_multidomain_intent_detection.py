...
BUILTIN_TEST_QUERIES: List[Dict[str, str]] = [
    ...
    {"query": "What is the full name and date of birth for this member?", "expected_domain": "member_domain", "expected_intent": "member_demographics"},
    {"query": "What is the email address on file for this member?", "expected_domain": "member_domain", "expected_intent": "member_contact_info"},
    {"query": "What is the brand copay set on this member's eligibility?", "expected_domain": "member_domain", "expected_intent": "member_eligibility_copay"},
    {"query": "What is the transition status for this member?", "expected_domain": "member_domain", "expected_intent": "member_transition_status"},
    {"query": "What is the DUR configuration key for this member?", "expected_domain": "member_domain", "expected_intent": "member_dur_config"},
    {"query": "What is the MBI number for this member?", "expected_domain": "member_domain", "expected_intent": "member_mbi_number"},
    {"query": "Show the caretaker information for this Medicare member.", "expected_domain": "member_domain", "expected_intent": "member_caretaker_info"},
    {"query": "What is the language preference for this member?", "expected_domain": "member_domain", "expected_intent": "member_language_pref"},
    {"query": "What discount program is assigned to this member?", "expected_domain": "member_domain", "expected_intent": "member_discount_program"},
    {"query": "Does this member have an override plan on file?", "expected_domain": "member_domain", "expected_intent": "member_override_plan"},
    # ── override_domain ──────────────────────────────────────────────────
    ...
    {"query": "What is the reason code on this PA?", "expected_domain": "override_domain", "expected_intent": "pa_reason_code"},
    {"query": "What are the effective dates for this PA?", "expected_domain": "override_domain", "expected_intent": "pa_effective_dates"},
    {"query": "What is the agent code on this PA?", "expected_domain": "override_domain", "expected_intent": "pa_agent_code"},
    {"query": "What is the ignore status code on this PA?", "expected_domain": "override_domain", "expected_intent": "pa_ignore_status"},
    {"query": "Does this PA override the specialty prescription reject?", "expected_domain": "override_domain", "expected_intent": "pa_specialty_rx_override"},
    {"query": "What is the clinical administration code on this PA?", "expected_domain": "override_domain", "expected_intent": "pa_clinical_admin_code"},
    {"query": "What is the transform care type on this PA?", "expected_domain": "override_domain", "expected_intent": "pa_transform_care"},
    {"query": "Is follow me logic enabled on this PA?", "expected_domain": "override_domain", "expected_intent": "pa_follow_me_logic"},
    {"query": "What is the authorized drug type on this PA?", "expected_domain": "override_domain", "expected_intent": "pa_drug_type_indicator"},
    {"query": "When was this PA last modified?", "expected_domain": "override_domain", "expected_intent": "pa_modification_history"},
    # ── general ──────────────────────────────────────────────────────────
