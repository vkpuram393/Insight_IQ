...
CONFUSION_PAIRS: Dict[str, set] = {
    "approval_info":       {"prior_auth_info", "claim_status", "member_transition_status"},
    "prior_auth_info":     {"approval_info", "pa_summary", "PriorAuth"},
    "rejection_reasons":   {"help", "claim_status"},
    "help":                {"rejection_reasons", "member_demographics"},
    ...
    "member_demographics": {"member_contact_info", "help"},
    ...
    "beneficiary_info":    {"approval_info", "member_coverage", "medicare_part_d", "date_range_claims"},
    "greeting":            {"out_of_scope"},
    "out_of_scope":        {"greeting"},
    # ── NEW: From accuracy report confusion analysis ────────────────
    "mail_order_info":     {"PharmType", "DaysSupply", "plan_finder"},
    "PharmType":           {"mail_order_info", "Pharmacy"},
    "Prescriber":          {"prescriber_info"},
    "prescriber_info":     {"Prescriber"},
    "plan_summary":        {"member_coverage", "plan_history", "drug_info"},
    "member_coverage":     {"plan_summary", "beneficiary_info"},
    "pa_follow_me_logic":  {"member_transition_status", "prior_auth_info"},
    "member_transition_status": {"pa_follow_me_logic", "approval_info"},
    "pa_field_help":       {"pa_ignore_status", "pa_summary"},
    "pa_agent_code":       {"pa_modification_history"},
    "medicare_part_d":     {"medicare_coverage", "pricing_info", "lics_status", "beneficiary_info"},
    ...
    "Refills":             {"rx_details"},
    # ── NEW: From hybrid run failure analysis ───────────────────────
    "lics_status":         {"medicare_part_d"},
    "plan_finder":         {"mail_order_info"},
    "reversal_info":       {"Status"},
    "Status":              {"reversal_info"},
    "pa_summary":          {"prior_auth_info"},
    "pa_copay_pricing":    {"member_eligibility_copay"},
    "member_eligibility_copay": {"pa_copay_pricing"},
    "cob_info":            {"alternate_insurance"},
    "alternate_insurance": {"cob_info"},
    "DaysSupply":          {"mail_order_info"},
    "date_range_claims":   {"beneficiary_info"},
    "drug_info":           {"plan_summary"},
}
