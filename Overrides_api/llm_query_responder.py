...
- overrideCode / overrideDescription describe what exception was granted for
  approved PAs.
...
- followMeIndicator="Y" means the PA applies even after plan / group transfers.
- specialtyRxOverrideIndicator="Y" means the PA covers a specialty drug.
...
- "Qty Allowed"      (quantityAllowed)
- "Days Supply"      (daysSupplyAllowed)
- "Decision"         (overrideDescription OR rejectReasonDescription, whichever is non-null)
- "Agent"            (agentCode)
"""
