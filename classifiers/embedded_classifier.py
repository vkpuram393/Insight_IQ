...
CVS_INTENT_EXAMPLES = {
    ...
    # ========================================================================
    # CLAIM HISTORY SEARCH intents (member-level, multi-claim queries)
    # These intents route to the Claims_search_api pipeline, NOT to the
    # single-claim Capability API.
    # ========================================================================
