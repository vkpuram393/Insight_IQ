...
INTENT_DESC = {
    ...
    "pa_contingent_therapy_override": "How to bypass/override contingent therapy on a PA",
    "pa_smart_pa_override": "How to bypass/override Smart PA processing, enter criteria number",
    "pa_part_b_override": "How to make claim pay as Medicare Part-B using reason code MB",
    "pa_esrd_override": "How to override ESRD reject using reason code ES",
    "pa_skip_deductible": "How to skip deductible for member using PA, flip skip DED flag",
    "pa_send_expiration": "How to send PA expiration date on a claim",
    "pa_tf_letter_setup": "How to setup TF (Transition Fill) letter tag on a PA",
    "pa_copay_setup": "How to configure a different copay schedule on a PA override",
    "pa_suggest_override": "What PA to enter for overriding a reject, suggest override feature",
    "pa_reason_code_fields": "What fields are applicable for a specific PA override reason code",
}
